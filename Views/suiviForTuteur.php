    ...
    <section class="section_patient_vitalSign">
        ...
        <section class="other_patient_attributs" style="display:none;"> 
            ...
            <div class="attributs_patient" style = "margin-bottom:30px;">
                ...
                <p id="p_commune_quater"> </p>
            </div>

            <h1>Information sur le Médecin</h1> <hr style="color:#1F57EC; width:200px; margin-bottom:10px;">
            <div class="orther_info_patient">
                <p id="d_name_doctor">Nom médecin :</p>
                <p id="d_mail_doctor">Mail :</p>
                <p id="d_contact_doctor">Contact :</p>
            </div>

            <div class="no_medecin_classe">
                Aucun Médecin fait le suivi de votre patient
            </div>
        </section>
        ...
        <section class="vitalSign_grid">
            <section class="view_vitalSign">
                ...
                <div class="state_health" style="margin-bottom: 20px;">
                    <p id="state_hz" style="background-color: #B987AD; color:white;">...</p>
                </div>
            ...
            <section class="view_vitalSign">
                ...
                <div class="state_health" style="margin-bottom: 20px;">
                    <p id="state_spo2" style="background-color:#F8DEBD;">...</p>
                </div>
            ...
            <section class="view_vitalSign">
                ...
                <div class="state_health" style="margin-bottom: 20px;">
                    <p id="state_temp" style="background-color: #F9C4C3;">...</p>
                </div>
            ...
            <section class="view_vitalSign">
                ...
                <div class="state_health" style="margin-bottom: 20px;">
                    <p id="state_pression" style="background-color:#F3DBDC;">...</p>
                </div>
