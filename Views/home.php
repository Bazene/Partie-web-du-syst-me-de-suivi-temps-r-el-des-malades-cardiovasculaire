...
<body>
    ...
    <section class="right_part">
        <section class="dashboards_section">
            <h2 style="margin-bottom: 10px; width: 80px; font-size:16px; color:#1F57EC; padding:10px; background-color: #D7E5FF;">Dashboard</h2>
            ...
            <div class="stats_dashbord" style="display: flex; flex-direction: row;">
                <div class="patient_follow">
                        ...
                        <div style="display: flex; flex-direction: row; justify-content: flex-start; align-items: center;">
                            <strong> <span style="font-size:20px; margin-right:5px; margin-left: 5px; color:black;">100</span> </strong> <br> 
                        </div>
                </div>
                ...
                <div class="patient_follow" style="margin-left: 20px; background:linear-gradient(to right, #1FED8D, #1FED8D, #1FED8D);">
                        ...
                        <div style="display: flex; flex-direction: row; justify-content: flex-start; align-items: center;">
                            <strong> <span style="font-size:20px; margin-right:5px; margin-left: 5px; color:black;">5</span> </strong> <br>
                        </div>
                </div>
        ...
        <section class="header_patient_follow_section">
            <h2 style="margin-bottom: 10px; font-size:20px; color:black; padding:10px;">Patients suivi</h2>
        ...
        <section class="display_users_section">
            <!-- my_patients section her bellows is the section that will be generate for each section -->
                ...
                <div class="stroke_section">
                    ...
                    <div class="info">
                        <div style="text-align:center; color:black;">
                            <strong style="font-size:16px; margin-bottom:5px;">Bazene Serge</strong> <br>
                            <span style="font-size:14px; color:gray;">+243 975 149 026 </span>
                        </div> 

                        <div class="btn_follow_patient">
