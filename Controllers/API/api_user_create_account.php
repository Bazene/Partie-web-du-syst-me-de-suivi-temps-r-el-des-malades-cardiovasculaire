<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        try {
            ...
            // creat a new patient
            $new_patient = new Patient(null, null, $patient_name, $patient_postname, $patient_surname, $patient_gender, $patient_phone_number, $patient_mail,  $hashedPassword, "picture", "commune", "quater", $patient_date_created, $patient_age, 0, 0, $patient_role);
            ...
            if(!$patientAllReadyExist) {
                $id_patient = $new_patient->createPatient();
                if($id_patient !== null) {
                    ...
                    // if($patientId != null ) {
                        ...
                        $limitesVital = new Limitesvitalsignspatient($id_patient, 36, 38, 90, 100, 50, 100, "108/75", "126/83", 70, 110);
                        ...
                        if($limitesVital->createLimitesVitalSign()) {
                            ...
                            echo json_encode(["success" => false, "error" => "Faild to create limite"]);
                        }
                    // }  else {
                    //     echo json_encode(["success" => false, "error" => "Faild to get id_patient"]);
                    // }
                } 
                else {
